...
import lib.src.catatan_jadwal.presentation.tambah_catatan_jadwal_screen as tambah_catatan_jadwal_screen
...
class HomeButton(ft.Container):
    def __init__(self, page: ft.Page):
        super().__init__(
            ...
            margin=ft.margin.only(left=70, top=100),
...
class AddButton(ft.Container):
    # TODO : ganti icon / foto atau apapun itu
    def tambah_jadwal_button_on_click(self, e):
        self.page.controls.clear()
        print("tambah jadwal")
        tambah_catatan_jadwal_screen.main(self.page)
        # self.page.update()
    ...
    def __init__(self):
        super().__init__(
            ...
            border=ft.border.all(width=5, color="#FFFFFF"),
            border_radius=ft.border_radius.all(10),
            on_click=self.tambah_jadwal_button_on_click,
            width=380,
            height=64,
            margin=ft.margin.only(left=210, top=20, bottom=20, right=20),
        )
